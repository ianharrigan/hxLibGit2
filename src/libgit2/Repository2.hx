...
import libgit2.RevWalk2.SortFlags2;
...
static int credentialsCallback(git_cred ** cred, const char * url, const char * username_from_url, unsigned int allowed_types, void * payload) {
    if ((allowed_types & GIT_CREDTYPE_USERPASS_PLAINTEXT) != 0) {
        return git_cred_userpass_plaintext_new(cred, libgit2::Repository2_obj::_currentUsername.c_str(), libgit2::Repository2_obj::_currentPassword.c_str());
    } else {
...
class Repository2 extends Common {
    ...
    public function createWalker(sorting:Null<Int> = null, pushHead:Bool = true, hideGlob:String = "tags/*"):RevWalk2 {
        var walker = new RevWalk2(this);
        if (sorting != null) {
    ...
    public function commits(spec:String = "HEAD~10"):CommitIterator {
        var walker = createWalker(SortFlags2.Time | SortFlags2.Topological);
    ...
    public function createCommit(message:String, ref:String = "HEAD", author:Signature2 = null, committer:Signature2 = null, tree:Tree = null, parents:Array<Commit2> = null):Commit2 {
    ...
    public function push(remoteName:String = "origin", refSpec:String = "HEAD:refs/heads/master") {
        ...
        if (user != null) {
            ...
            remoteCallbacks.credentials = untyped __cpp__("&libgit2::Repository2_obj::credentialsCallback");
        }
